...
public class RightNavigationButton extends AppCompatButton {
    ...
    public RightNavigationButton(@NonNull Context context) {
        this(context, null);
    }

    public RightNavigationButton(@NonNull Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RightNavigationButton(@NonNull Context context, AttributeSet attrs, int defStyleAttr) {
