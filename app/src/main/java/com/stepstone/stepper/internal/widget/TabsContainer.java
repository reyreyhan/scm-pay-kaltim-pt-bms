...
public class TabsContainer extends FrameLayout {
    ...
    public TabsContainer(@NonNull Context context) {
        this(context, null);
    }

    public TabsContainer(@NonNull Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public TabsContainer(@NonNull Context context, AttributeSet attrs, int defStyleAttr) {
     ...
     */
    public void setSteps(@NonNull List<StepViewModel> stepViewModels) {
     ...
     */
    public void updateSteps(int currentStepPosition, @NonNull SparseArray<VerificationError> stepErrors, boolean showErrorMessageEnabled) {
