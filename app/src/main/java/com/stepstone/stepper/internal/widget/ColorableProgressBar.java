...
public class ColorableProgressBar extends ProgressBar {
    ...
    public ColorableProgressBar(@NonNull Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ColorableProgressBar(@NonNull Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private static final Property<ProgressBar, Integer> PROGRESS_PROPERTY = new Property<ProgressBar, Integer>(Integer.class, "progress") {
        ...
        @Override
        public void set(@NonNull ProgressBar object, Integer value) {
            object.setProgress(value);
        }

        @Override
        public Integer get(@NonNull ProgressBar object) {
