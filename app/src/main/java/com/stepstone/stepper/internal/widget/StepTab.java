...
public class StepTab extends RelativeLayout {
    ...
    public StepTab(@NonNull Context context) {
        this(context, null);
    }

    public StepTab(@NonNull Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public StepTab(@NonNull Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    /**
     * Sets the airLineName of the step
     *
     * @param title step airLineName
     */
    ...
    class WarningState extends AbstractState {
        ...
        private void animateViewIn(@NonNull final View view) {
