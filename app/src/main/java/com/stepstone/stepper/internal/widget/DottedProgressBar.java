...
public class DottedProgressBar extends LinearLayout {
    ...
    public DottedProgressBar(@NonNull Context context) {
        this(context, null);
    }

    public DottedProgressBar(@NonNull Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public DottedProgressBar(@NonNull Context context, AttributeSet attrs, int defStyleAttr) {
