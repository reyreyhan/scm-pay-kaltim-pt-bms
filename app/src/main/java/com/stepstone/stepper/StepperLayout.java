...
public class StepperLayout extends LinearLayout implements TabsContainer.TabItemListener {
    ...
    private void setBackgroundIfPresent(@DrawableRes int backgroundRes, @NonNull View view) {
        if (backgroundRes != 0) {
    ...
    private void extractValuesFromAttributes(@Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
        if (attrs != null) {
    ...
    private boolean verifyCurrentStep(@NonNull Step step) {
