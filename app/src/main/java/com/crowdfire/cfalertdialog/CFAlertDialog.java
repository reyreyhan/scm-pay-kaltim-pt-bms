...
public class CFAlertDialog extends AppCompatDialog {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ViewGroup parent = findViewById(R.id.cfdialog_background);
        View view = View.inflate(getContext(),R.layout.cfalert_layout, parent);
    ...
    private void setupSubviews(@NonNull View view) {
    ...
    private void createCardView() {
        ...
        dialogCardView = findViewById(R.id.cfdialog_cardview);
    ...
    public void setContentImageDrawable(@Nullable Drawable imageDrawable) {
    ...
    private void setViewEnabled(@NonNull ViewGroup layout, boolean enabled) {
    ...
    private void disableClipOnParents(@NonNull View v) {
        if (v.getParent() == null) {
            return;
        }
    ...
    private void populateButtons(@NonNull Context context, @NonNull List<CFAlertActionButton> buttons) {
    ...
    @Nullable
    private View createButton(@NonNull Context context, @NonNull final CFAlertActionButton actionButton) {
    ...
    private void setButtonLayout(@NonNull View buttonView, @NonNull CFAlertActionButton actionButton) {
    ...
    private void setButtonColors(@NonNull CFPushButton button, @NonNull CFAlertActionButton actionButton) {
    ...
    public void setItems(@Nullable String[] items, @Nullable final OnClickListener onClickListener) {
        ...
        if (items != null && items.length > 0) {
            ...
            for (int i = 0; i < items.length; i++) {
                String item = items[i];
                ViewGroup parent = findViewById(R.id.cfdialog_selectable_item);
                View view = View.inflate(getContext(),R.layout.cfdialog_selectable_item_layout, parent);
    ...
    public void setMultiSelectItems(@Nullable String[] multiSelectItems, @NonNull boolean[] selectedItems, @Nullable final OnMultiChoiceClickListener onMultiChoiceClickListener) {
        if (multiSelectItems != null && multiSelectItems.length > 0) {
            ...
            for (int i = 0; i < multiSelectItems.length; i++) {
                ...
                ViewGroup parent = findViewById(R.id.cfdialog_multi_select_item);
                View view = View.inflate(getContext(),R.layout.cfdialog_multi_select_item_layout, parent);
                CheckBox checkBox = view.findViewById(R.id.cfdialog_multi_select_item_checkbox);
    ...
    public void setSingleSelectItems(@Nullable String[] singleSelectItems, int selectedItem, @Nullable final OnClickListener onClickListener) {
        if (singleSelectItems != null && singleSelectItems.length > 0) {
            selectableItemsContainer.removeAllViews();
            selectableItemsContainer.setVisibility(View.VISIBLE);
            RadioGroup radioGroup = getLayoutInflater().inflate(R.layout.cfdialog_single_select_item_layout, selectableItemsContainer) .findViewById(R.id.cfstage_single_select_radio_group);
            radioGroup.removeAllViews();
            for (int i = 0; i < singleSelectItems.length; i++) {
                String item = singleSelectItems[i];
//                RadioButton radioButton = (RadioButton) getLayoutInflater().inflate(R.layout.cfdialog_single_select_radio_button_layout, radioGroup);
                RadioButton radioButton = (RadioButton)View.inflate(getContext(),R.layout.cfdialog_single_select_radio_button_layout, radioGroup);
    ...
    private Animation getPresentAnimation(@NonNull CFAlertStyle style) {
        switch (style) {
            case NOTIFICATION:
    ...
    private Animation getDismissAnimation(@NonNull CFAlertStyle style) {
        switch (style) {
            case NOTIFICATION:
    ...
    private float getCornerRadius(){
        ...
        // Special layout properties to be added here.
        if (params.dialogStyle == CFAlertStyle.NOTIFICATION) {
            cornerRadius = 0;
        }
    ...
    public static class Builder {
        ...
        @NonNull
        public Builder addButton(String buttonText, @ColorInt int textColor, @ColorInt int backgroundColor, @NonNull CFAlertActionStyle style, CFAlertActionAlignment alignment, OnClickListener onClickListener) {
    ...
    private static class DialogParams {
        ...
        public boolean isDialogBodyEmpty() {
            ...
            return multiSelectItems == null || multiSelectItems.length == 0;
    ...
    private static class CFAlertActionButton {
        ...
        public CFAlertActionButton(Context context, String buttonText, @ColorInt int textColor, @ColorInt int backgroundColor, @NonNull CFAlertActionStyle style, CFAlertActionAlignment alignment, OnClickListener onClickListener) {
        ...
        private @DrawableRes int getBackgroundDrawable(@NonNull CFAlertActionStyle style) {
        ...
        private @ColorInt int getTextColor(@NonNull CFAlertActionStyle style) {
...
//        public Builder setBackgroundResource(@ColorRes int backgroundResource) {
//         //   this.params.backgroundColor = ResourcesCompat.getColor(this.params.context.getResources(), backgroundResource, null);
//            this.params.backgroundColor = ContextCompat.getColor(this.params.context, backgroundResource);
//            return this;
//        }
//
//        public Builder setBackgroundColor(@ColorInt int backgroundColor) {
...
//        public Builder setDialogBackgroundResource(@ColorRes int backgroundResource) {
//           // this.params.dialogBackgroundColor = ResourcesCompat.getColor(this.params.context.getResources(), backgroundResource, null);
//            this.params.dialogBackgroundColor = ContextCompat.getColor(this.params.context, backgroundResource);
//            return this;
//        }
//
//        public Builder setDialogBackgroundColor(@ColorInt int backgroundColor) {
