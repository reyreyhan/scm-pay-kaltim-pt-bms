package com.bm.main.pos.feature.manage.customer.transaction
...
import com.bm.main.pos.feature.manage.customer.transaction.CustomerTransactionAdapter
...
class CustomerTransactionFragment : BaseFragment<CustomerTransactionPresenter, CustomerTransactionContract.View>(),
    ...
    private val TAG = CustomerTransactionFragment::class.java.simpleName
    ...
    override fun createPresenter(): CustomerTransactionPresenter {
        return CustomerTransactionPresenter(activity as Context, this)
    }
