...
class BottomDialog : BottomSheetDialogFragment() {
    ...
    private var data: List<DialogModel>? = null
    private var title: String? = ""
    private var type: Int? = -1
    private var selected: DialogModel? = null
    private var action = ""
    ...
    fun setData(title: String, type: Int, list: List<DialogModel>, select: DialogModel?) {
        this.title = title
        this.type = type
        data = list
        selected = select
    ...
    fun setAction(label: String, handler: () -> Unit = {}) {
        action = label
    ...
    interface Listener {
        fun onItemClicked(data: DialogModel, type: Int)
    }
...
//        internal val icon: ImageView = itemView.icon_iv
    ...
    private inner class ItemAdapter internal constructor(
        val data: List<DialogModel>,
        val selected: DialogModel?
    ) :
        ...
        override fun onBindViewHolder(holder: ViewHolder, position: Int) {
            ...
            holder.button.text = place.value
