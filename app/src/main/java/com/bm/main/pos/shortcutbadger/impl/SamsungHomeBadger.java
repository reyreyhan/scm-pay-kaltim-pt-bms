...
import com.bm.main.pos.shortcutbadger.util.CloseHelper;
...
public class SamsungHomeBadger implements Badger {
    ...
    @NonNull
    private ContentValues getContentValues(@NonNull ComponentName componentName, int badgeCount, boolean isInsert) {
