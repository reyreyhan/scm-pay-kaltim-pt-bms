...
import com.bm.main.pos.feature.dialog.CartCountDialog
import com.bm.main.pos.feature.dialog.SingleDateDialog
import com.bm.main.pos.feature.kulakan.chooseSupplier.ChooseSupplierActivity
...
class KulakanActivity : BaseActivity<KulakanPresenter, KulakanContract.View>(),
    ...
    override fun openAddManual(barcode: String) {
        val intent = Intent(this, com.bm.main.pos.feature.sell.add.AddActivity::class.java)
