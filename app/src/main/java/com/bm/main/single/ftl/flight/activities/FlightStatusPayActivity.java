...
public class FlightStatusPayActivity extends BaseActivity implements ProgressResponseCallback, View.OnClickListener {
    private static final String TAG = FlightStatusPayActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.flight_status_pay_activity);
        ...
        TextView textViewKomisi= findViewById(R.id.textViewKomisiFlight);
...
//                Intent intent = null;
////                try {
//                intent = new Intent(FlightStatusPayActivity.this, FlightSearchActivity.class);
...
//                Intent intent = null;
////                try {
//                intent = new Intent(FlightStatusPayActivity.this, SearchTrainActivity.class);
//                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
//                startActivity(intent);
////                } catch (ClassNotFoundException e) {
////                    e.printStackTrace();
...
//                Intent intent = null;
////                try {
//                intent = new Intent(FlightStatusPayActivity.this, StartHotelActivity.class);
//                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
//                startActivity(intent);
////                } catch (ClassNotFoundException e) {
////                    e.printStackTrace();
...
//                Intent intent = null;
////                try {
//                intent = new Intent(FlightStatusPayActivity.this, ToursTiketingActivity.class);
//                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
//                startActivity(intent);
//                } catch (ClassNotFoundException e) {
//                    e.printStackTrace();
...
//        nama_pdf = arr_nama_pdf[1];
        getStruk(urlStruk, 0, this);
        //  doCekPDF(idTrx, urlEtiket);
...
//    }
    ...
    public void onBackPressed() {
       // Intent intent = new Intent(FlightStatusPayActivity.this, FlightSearchActivity.class);
//        intent.putExtra("isFromPay",true);
//        startActivity(intent);
////        finish();
//        ActivityCompat.finishAffinity(FlightStatusPayActivity.this);
        setResult(RESULT_OK);
        finish();
        overridePendingTransition(R.anim.fade_in, R.anim.fade_out);
    }
...
//            SharedPreferenceUtils.getInstance(StatusPayFlightActivty.this).getJSONObject("data");
            ...
            if (ContextCompat.checkSelfPermission(FlightStatusPayActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE)
                    + ContextCompat.checkSelfPermission(FlightStatusPayActivity.this, Manifest.permission.READ_EXTERNAL_STORAGE)
                    != PackageManager.PERMISSION_GRANTED) {

                //    Log.i("Permission is require first time", "...OK...getPermission() method!..if");
                ActivityCompat.requestPermissions(FlightStatusPayActivity.this,
...
//        Intent intent = new Intent(FlightStatusPayActivity.this, ShowPdfActivity.class);
//        intent.putExtra("namaPdf", idTrx);
//        intent.putExtra("urlPdf", urlEtiket);
//        intent.putExtra("produk", "Pesawat");
String produk="Pesawat";
...
//                        Uri uri =  FileProvider.getUriForFile(FlightStatusPayActivity.this, "com.bm.main.fpl.fileprovider", file);
...
//                });
                    ...
                    FileUtils.openPdf(FlightStatusPayActivity.this,file);
                } else {
//                                            showToastCustom(DaftarPesananActivity.this, 1, "File tidak ditemukan!");
                    snackBarCustomAction(findViewById(R.id.rootLayout), 0, "File tidak ditemukan!", 1);
                }
