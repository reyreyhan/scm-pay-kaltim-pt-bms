...
public class ShipDataModelDataFaresFARE_DETAILI implements Parcelable {
    public static final Creator<ShipDataModelDataFaresFARE_DETAILI> CREATOR = new Creator<ShipDataModelDataFaresFARE_DETAILI>() {
        @NonNull
        @Override
        public ShipDataModelDataFaresFARE_DETAILI createFromParcel(@NonNull Parcel source) {
            ShipDataModelDataFaresFARE_DETAILI var = new ShipDataModelDataFaresFARE_DETAILI();
        ...
        @NonNull
        @Override
        public ShipDataModelDataFaresFARE_DETAILI[] newArray(int size) {
            return new ShipDataModelDataFaresFARE_DETAILI[size];
        }
    };
    private int TOTAL;
    @Nullable
