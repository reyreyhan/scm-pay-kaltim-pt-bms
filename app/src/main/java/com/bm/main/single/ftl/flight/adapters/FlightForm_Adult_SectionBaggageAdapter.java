...
public class FlightForm_Adult_SectionBaggageAdapter extends RecyclerView.Adapter<FlightForm_Adult_SectionBaggageAdapter.ItemRowHolder> {

    private ArrayList<SectionDataPassagerModel> dataList;
    private Context mContext;
    public FlightSectionListDataPassagerAdapter itemListDataAdapter;
    public FlightForm_Adult_SectionBaggageAdapter(Context context, ArrayList<SectionDataPassagerModel> dataList) {
    ...
    public ItemRowHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.flightform_adult_sectionbaggage_list_item, null);
