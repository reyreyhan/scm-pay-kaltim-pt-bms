...
public class FlightFormBaggageModel implements java.io.Serializable {
    ...
    private ArrayList<SingleItemBaggageModel> sectionDataPassagerModels;


    public FlightFormBaggageModel(){

    }

    public FlightFormBaggageModel(String flightIcon, String flightName, String flightCode, String arrival, String destination, ArrayList<SingleItemBaggageModel> sectionDataPassagerModels) {
    ...
    public ArrayList<SingleItemBaggageModel> getSectionDataPassagerModels() {
        return sectionDataPassagerModels;
    }

    public void setSectionDataPassagerModels(ArrayList<SingleItemBaggageModel> sectionDataPassagerModels) {
        this.sectionDataPassagerModels = sectionDataPassagerModels;
    }
