...
import com.bm.main.scm.shortcutbadger.util.BroadcastHelper;
...
public class OPPOHomeBader implements Badger {
    ...
    private void executeBadgeByBroadcast(@NonNull Context context, @NonNull ComponentName componentName,
    ...
    private void executeBadgeByContentProvider(@NonNull Context context, int badgeCount) throws ShortcutBadgeException {
        try {
