...
class HomeTransactionAdapter (var list:MutableList<QrTransaction>,
                              val itemClickListener: OnItemClickListener) : RecyclerView.Adapter<HomeTransactionAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        return ViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.item_transaction_merchant_scm, parent, false))
    }
