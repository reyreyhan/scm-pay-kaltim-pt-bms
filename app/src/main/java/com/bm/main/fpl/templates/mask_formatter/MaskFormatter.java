...
public class MaskFormatter implements TextWatcher {
    ...
    public MaskFormatter(String mask, @NonNull EditText maskedField) {
        this(mask, maskedField, SPACE);
    }

    public MaskFormatter(String mask, @NonNull EditText maskedField, char maskCharacter) {
        this.mask = mask;
    ...
    private int getPasswordMask(@NonNull EditText maskedField) {
    ...
    @Override
    public void beforeTextChanged(@NonNull CharSequence s, int index, int toBeReplacedCount, int addedCount) {
        textBefore = s.toString();
        selectionBefore = maskedField.getSelectionEnd();
    }

    @Override
    public void onTextChanged(@NonNull CharSequence s, int index, int replacedCount, int addedCount) {
        if (editTextChange) {
    ...
    private int countNewIndex(int addedCount, @NonNull String appliedMaskString) {
    ...
    private int newIndexForRemovingCharacters(@NonNull String appliedMaskString) {
    ...
    private int newIndexForAddingCharacters(@NonNull String appliedMaskString) {
        if (selectionBefore >= appliedMaskString.length()) {
    ...
    @NonNull
    private String applyMask(@NonNull String newValue) throws InvalidTextException {
