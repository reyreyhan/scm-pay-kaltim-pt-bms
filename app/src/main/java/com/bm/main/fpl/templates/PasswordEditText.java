...
/**
 * Created by Sarif Hidayat on 11/05/2017.
 */
...
public class PasswordEditText extends MaterialEditText {
    ...
    @DrawableRes
    private int showPwIcon = R.drawable.ic_visible_eye;

    @DrawableRes
    private int hidePwIcon = R.drawable.ic_invisible_eye;
    ...
    public void initFields(@Nullable AttributeSet attrs, int defStyleAttr) {
