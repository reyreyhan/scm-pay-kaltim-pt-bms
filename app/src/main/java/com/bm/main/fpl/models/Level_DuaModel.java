...
public class Level_DuaModel extends BaseObject implements Parcelable {

    @SerializedName("response_value")
    private ArrayList<Response_value> response_value;
    private Level_DuaModel(Parcel in) {
    }

    public static final Creator<Level_DuaModel> CREATOR = new Creator<Level_DuaModel>() {
        @NonNull
        @Override
        public Level_DuaModel createFromParcel(Parcel in) {
            return new Level_DuaModel(in);
        }

        @NonNull
        @Override
        public Level_DuaModel[] newArray(int size) {
            return new Level_DuaModel[size];
        }
    };

    public ArrayList<Level_DuaModel.Response_value> getResponse_value() {
        return response_value;
    }

    public void setResponse_value(ArrayList<Level_DuaModel.Response_value> response_value) {
    ...
    public static class Response_value implements Parcelable {
        ...
        public static final Creator<Level_DuaModel.Response_value> CREATOR = new Creator<Level_DuaModel.Response_value>() {
            @NonNull
            @Override
            public Level_DuaModel.Response_value createFromParcel(@NonNull Parcel in) {
                return new Level_DuaModel.Response_value(in);
            }

            @NonNull
            @Override
            public Level_DuaModel.Response_value[] newArray(int size) {
                return new Level_DuaModel.Response_value[size];
            }
        };
