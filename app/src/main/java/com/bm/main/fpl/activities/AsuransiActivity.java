...
public class AsuransiActivity extends KeyboardListenerActivity implements JsonObjectResponseCallback {
    private static final String TAG = AsuransiActivity.class.getSimpleName();
...
//    AppCompatButton appButtonItemTabDaftarPelanggan;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        logEventFireBase(ProdukGroup.ASURANSI, ProdukGroup.ASURANSI, EventParam.EVENT_ACTION_VISIT, EventParam.EVENT_SUCCESS, TAG);
        toolbar = findViewById(R.id.toolbar);
        toolbar.setTitle("Asuransi");
        init(0);
...
//        });
        ...
        materialEditTextProduk.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(AsuransiActivity.this, ListGridProdukActivity.class);

                intent.addFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP);
                intent.putExtra("title", "Produk Asuransi");
                intent.putExtra("product", "ASURANSI");
                intent.putExtra("hint", "Cari Asuransi");
...
//        radioTabs.setOnCheckedChangeListener(this);
        ...
        button_lanjutkan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (materialEditTextProduk.getText().toString().isEmpty()) {
                    materialEditTextProduk.setAnimation(BaseActivity.animShake);
                    materialEditTextProduk.startAnimation(BaseActivity.animShake);
                    materialEditTextProduk.setError("Produk Asuransi Tidak Boleh Kosong");
                    Device.vibrate(AsuransiActivity.this);
                    return;
                }
        ...
        requestPopUpPromo("ASURANSI");
        // materialEditTextIdPelanggan.requestFocus();
        ...
        new Handler().post(new Runnable() {
            ...
            public void run() {
                ...
                if (PreferenceClass.getInt(TAG, 0) != 1) {
                    showCaseFirst(AsuransiActivity.this, "", getResources().getString(R.string.content_icon_scanner), menuItemView);
...
//                                    break;
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.action_right_drawer) {
            ...
            openScanner(AsuransiActivity.this);
    ...
    private void requestInq() {
        logEventFireBase(ProdukGroup.ASURANSI, materialEditTextProduk.getText().toString(), EventParam.EVENT_ACTION_REQUEST_INQ, EventParam.EVENT_SUCCESS, TAG);
        JSONObject jsonObject = new JSONObject();
        try {
            jsonObject = new JSONObject(stringJson.requestInquiryAsuransi(produkCode, materialEditTextIdPelanggan.getText().toString(), isSave));
...
//                } else {
            ...
            if (inqModel.getResponse_code().equals(ResponseCode.SUCCESS)) {
                logEventFireBase(ProdukGroup.ASURANSI, materialEditTextProduk.getText().toString(), EventParam.EVENT_ACTION_RESULT_INQ, EventParam.EVENT_SUCCESS, TAG);
                ...
                Intent intent = new Intent(AsuransiActivity.this, InqueryResultActivity.class);

                intent.addFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP);
                intent.putExtra("title", ProdukGroup.ASURANSI);
                intent.putExtra("produkCode", produkCode);
                intent.putExtra("produkGroup", ProdukGroup.ASURANSI);
                ...
                logEventFireBase(ProdukGroup.ASURANSI, materialEditTextProduk.getText().toString(), EventParam.EVENT_ACTION_RESULT_INQ, EventParam.EVENT_NOT_SUCCESS, TAG);
...
//                appButtonItemTabIdPelanggan.setBackgroundDrawable(ContextCompat.getDrawable(AsuransiActivity.this,R.drawable.selector_tab_btn));
//                appButtonItemTabDaftarPelanggan.setBackgroundDrawable(ContextCompat.getDrawable(AsuransiActivity.this,R.drawable.unselector_tab_btn));
//                appButtonItemTabIdPelanggan.setTextColor(ContextCompat.getColor(AsuransiActivity.this,R.color.md_white_1000));
//                appButtonItemTabDaftarPelanggan.setTextColor(ContextCompat.getColor(AsuransiActivity.this,R.color.md_grey_300));
                break;
            case 1:
//                appButtonItemTabIdPelanggan.setBackgroundDrawable(ContextCompat.getDrawable(AsuransiActivity.this,R.drawable.unselector_tab_btn));
//                appButtonItemTabDaftarPelanggan.setBackgroundDrawable(ContextCompat.getDrawable(AsuransiActivity.this,R.drawable.selector_tab_btn));
//                appButtonItemTabIdPelanggan.setTextColor(ContextCompat.getColor(AsuransiActivity.this,R.color.md_grey_300));
//                appButtonItemTabDaftarPelanggan.setTextColor(ContextCompat.getColor(AsuransiActivity.this,R.color.md_white_1000));
                if (materialEditTextProduk.getText().toString().isEmpty()) {
                    ...
                    intent.addFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP);
                    intent.putExtra("title", "Pelanggan Asuransi");
