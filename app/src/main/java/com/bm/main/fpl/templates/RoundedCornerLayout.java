...
public class RoundedCornerLayout extends FrameLayout {
    ...
    public RoundedCornerLayout(@NonNull Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs, 0);
    }

    public RoundedCornerLayout(@NonNull Context context, AttributeSet attrs, int defStyle) {
