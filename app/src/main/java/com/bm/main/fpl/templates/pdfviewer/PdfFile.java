...
import com.bm.main.fpl.templates.pdfviewer.util.PageSizeCalculator;
...
class PdfFile {
    ...
    PdfFile(PdfiumCore pdfiumCore, PdfDocument pdfDocument, FitPolicy pageFitPolicy, @NonNull Size viewSize, int[] originalUserPages,
    ...
    private void setup(@NonNull Size viewSize) {
     ...
     */
    public void recalculatePageSizes(@NonNull Size viewSize) {
        pageSizes.clear();
    ...
    private void prepareAutoSpacing(@NonNull Size viewSize) {
        pageSpacing.clear();
    ...
    public void renderPageBitmap(Bitmap bitmap, int pageIndex, @NonNull Rect bounds, boolean annotationRendering) {
        int docPage = documentPage(pageIndex);
