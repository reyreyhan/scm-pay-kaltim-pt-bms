...
public class ListPropinsiAdapter extends RecyclerView.Adapter<ListPropinsiAdapter.ViewHolder> implements Filterable {
    @NonNull
    private final LayoutInflater inflater;
    ArrayList<PropinsiModel.Response_value>data = new ArrayList<>();
    ArrayList<PropinsiModel.Response_value>filterData = new ArrayList<>();
    Context context;
    OnClickProduk listener;
    public ListPropinsiAdapter(ArrayList<PropinsiModel.Response_value> data, @NonNull Context context, OnClickProduk listener){
        this.data = data;
    ...
    @NonNull
    @Override
    public ListPropinsiAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
...
//        );
    ...
    @Override
    public void onBindViewHolder(@NonNull final ListPropinsiAdapter.ViewHolder viewHolder, int i) {
        final PropinsiModel.Response_value produk = filterData.get(i);
        viewHolder.textViewPlusNamaProduk.setText(produk.getProp_name());
        viewHolder.textViewPlusNamaProduk.setTag(R.id.produkCode,produk.getProp_code());
...
//
        ...
        return new Filter() {
            ...
            protected FilterResults performFiltering(@NonNull CharSequence charSequence) {
                ...
                if (charString.isEmpty()) {
                    ...
                    ArrayList<PropinsiModel.Response_value> filteredList = new ArrayList<>();

                    for (PropinsiModel.Response_value produk : data) {

                        if (produk.getProp_name().toLowerCase().contains(charString)  ) {
            ...
            protected void publishResults(CharSequence charSequence, @NonNull FilterResults filterResults) {
                filterData = (ArrayList<PropinsiModel.Response_value>) filterResults.values;
    ...
    public interface OnClickProduk {
        public void onClickProduk(PropinsiModel.Response_value produk);
    }
}
