...
public class PgnActivity  extends KeyboardListenerActivity implements JsonObjectResponseCallback {
    private static final String TAG = PgnActivity.class.getSimpleName();
...
//    private RadioGroup radioTabs;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        logEventFireBase(ProdukGroup.PGN,ProdukCode.PGN,EventParam.EVENT_ACTION_VISIT,EventParam.EVENT_SUCCESS,TAG);
        toolbar = findViewById(R.id.toolbar);
        toolbar.setTitle("Perusahaan Gas Negara");
        init(0);
...
//                }
        ...
        button_lanjutkan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (materialEditTextIdPelanggan.getText().toString().isEmpty()) {
                    ...
                    Device.vibrate(PgnActivity.this);
                    return;
                }
        ...
        requestPopUpPromo("PGN");
        navigationBottomCustom(bottom_toolbar, PreferenceClass.getString("saldo", "0"));
        attachKeyboardListeners();
    }

    private void requestInq() {
        logEventFireBase(ProdukGroup.PGN,ProdukCode.PGN,EventParam.EVENT_ACTION_REQUEST_INQ,EventParam.EVENT_SUCCESS,TAG);
        JSONObject jsonObject = new JSONObject();
        try {
            jsonObject = new JSONObject(stringJson.requestPgnInquiry(materialEditTextIdPelanggan.getText().toString(), isSave));
        ...
        new Handler().post(new Runnable() {
            ...
            public void run() {
                ...
                if (PreferenceClass.getInt(TAG, 0) != 1) {
                    showCaseFirst(PgnActivity.this, "", getResources().getString(R.string.content_icon_scanner), menuItemView);
    ...
    private void requestLayout(int selectedTab) {
        ...
        switch (selectedTab) {
            case 0:
                ...
                appButtonItemTabIdPelanggan.setBackgroundDrawable(ContextCompat.getDrawable(PgnActivity.this, R.drawable.selector_tab_btn));
                appButtonItemTabDaftarPelanggan.setBackgroundDrawable(ContextCompat.getDrawable(PgnActivity.this, R.drawable.unselector_tab_btn));
                appButtonItemTabIdPelanggan.setTextColor(ContextCompat.getColor(PgnActivity.this, R.color.md_white_1000));
                appButtonItemTabDaftarPelanggan.setTextColor(ContextCompat.getColor(PgnActivity.this, R.color.md_grey_300));
                break;
            case 1:
                appButtonItemTabIdPelanggan.setBackgroundDrawable(ContextCompat.getDrawable(PgnActivity.this, R.drawable.unselector_tab_btn));
                appButtonItemTabDaftarPelanggan.setBackgroundDrawable(ContextCompat.getDrawable(PgnActivity.this, R.drawable.selector_tab_btn));
                appButtonItemTabIdPelanggan.setTextColor(ContextCompat.getColor(PgnActivity.this, R.color.md_grey_300));
                appButtonItemTabDaftarPelanggan.setTextColor(ContextCompat.getColor(PgnActivity.this, R.color.md_white_1000));
                Intent intent = new Intent(PgnActivity.this, DaftarPelangganActivity.class);

                intent.addFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP);
                intent.putExtra("title", "Pelanggan PGN");
                intent.putExtra("product", ProdukCode.PGN);
...
//                } else {
            ...
            switch (inqModel.getResponse_code()) {
                case ResponseCode.SUCCESS:
                    logEventFireBase(ProdukGroup.PGN, ProdukCode.PGN, EventParam.EVENT_ACTION_RESULT_INQ, EventParam.EVENT_SUCCESS, TAG);
                    ...
                    Intent intent = new Intent(PgnActivity.this, InqueryResultActivity.class);

                    intent.addFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP);
                    intent.putExtra("title", "PGN");
                    intent.putExtra("produkCode", ProdukCode.PGN);
                    intent.putExtra("subject", "PGN");
                    intent.putExtra("produkGroup", ProdukGroup.PGN);
                ...
                case "03":
                    ...
                    break;
                default:
                    logEventFireBase(ProdukGroup.PGN, ProdukCode.PGN, EventParam.EVENT_ACTION_RESULT_INQ, EventParam.EVENT_NOT_SUCCESS, TAG);
...
//if(findViewById(R.id.bottom_toolbar).isShown()) {
