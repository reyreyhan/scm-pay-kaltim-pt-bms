...
public class ExpandableBottomTabBar extends LinearLayout implements View.OnClickListener {
    ...
    public ExpandableBottomTabBar(@NonNull Context context) {
        super(context);
        init(context, null, 0);
    }

    public ExpandableBottomTabBar(@NonNull Context context, @NonNull AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs, 0);
    }

    public ExpandableBottomTabBar(@NonNull Context context, @NonNull AttributeSet attrs, int defStyleAttr) {
    ...
    private void populateAttributes(@NonNull Context context, @NonNull AttributeSet attrs) {
    ...
    private void parse(@NonNull XmlResourceParser parser) {
        try {
        ...
        } catch (@NonNull IOException | XmlPullParserException e) {
            e.printStackTrace();
        } finally {
    ...
    private void parseTabInfo(@NonNull XmlResourceParser parser) {
    ...
    private String getTitleValue(int attrIndex, @NonNull XmlResourceParser parser) {
    ...
    private void setBtmTabsVisibility(@NonNull View[] btmTabContainers, int visibility) {
        for (View btmTabContainer : btmTabContainers) {
            btmTabContainer.setVisibility(visibility);
        }
    }

    private void setLayoutParamsToBtmTabs(@NonNull View[] btmTabContainers, LayoutParams layoutParams) {
        for (View btmTabContainer : btmTabContainers) {
            btmTabContainer.setLayoutParams(layoutParams);
        }
    }

    private boolean isAnyBottomContainerVisible(@NonNull View[] btmTabContainers) {
