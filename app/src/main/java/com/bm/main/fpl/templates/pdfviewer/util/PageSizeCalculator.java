 ...
 */
package com.bm.main.fpl.templates.pdfviewer.util;
...
public class PageSizeCalculator {
    ...
    @NonNull
    public SizeF calculate(@NonNull Size pageSize) {
    ...
    @NonNull
    private SizeF fitWidth(@NonNull Size pageSize, float maxWidth) {
    ...
    @NonNull
    private SizeF fitHeight(@NonNull Size pageSize, float maxHeight) {
        float w = pageSize.getWidth(), h = pageSize.getHeight();
        float ratio = h / w;
        h = maxHeight;
    ...
    @NonNull
    private SizeF fitBoth(@NonNull Size pageSize, float maxWidth, float maxHeight) {
        float w = pageSize.getWidth(), h = pageSize.getHeight();
        float ratio = w / h;
        w = maxWidth;
        h = (float) Math.floor(maxWidth / ratio);
