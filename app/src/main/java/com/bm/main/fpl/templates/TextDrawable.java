...
public class TextDrawable extends Drawable implements TextWatcher {
    ...
    /**
     * Create da TextDrawable using the given paint object and string
     *
    ...
    /**
     * Create da TextDrawable. This uses the given TextView to initialize paint and has initial text
     ...
     */
    public TextDrawable(@NonNull TextView tv, String initialText, boolean bindToViewsText, boolean bindToViewsPaint) {
    ...
    /**
     * Create da TextDrawable. This uses the given TextView to initialize paint and the text that
     * will be drawn.
     *
     * @param tv               The TextView / EditText using to initialize this drawable
     * @param bindToViewsText  Should this drawable mirror the text in the TextView
     ...
     *                         Note, this will override any changes made using setColorFilter or setAlpha.
     */
    public TextDrawable(@NonNull TextView tv, boolean bindToViewsText, boolean bindToViewsPaint) {
     ...
     *
     * @param tv da TextView or EditText or any of their children.
     */
    public TextDrawable(@NonNull TextView tv) {
        this(tv, false, false);
    }
     ...
     */
    public TextDrawable(@NonNull TextView tv, String s) {
