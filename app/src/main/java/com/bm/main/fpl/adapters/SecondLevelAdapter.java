...
public class SecondLevelAdapter extends BaseExpandableListAdapter {
    ...
    private final List<DownlineModel> mListDataHeader;
    private final Map<DownlineModel, List<DownlineModelResponse_valueLevel2>> mListDataChild;

    public SecondLevelAdapter(Context mContext, List<DownlineModel> mListDataHeader, Map<DownlineModel, List<DownlineModelResponse_valueLevel2>> mListDataChild) {
