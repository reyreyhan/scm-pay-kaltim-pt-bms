...
/**
 * Created by sarifhidayat on 1/23/19.
 **/
...
public class StickHeaderItemDecoration extends RecyclerView.ItemDecoration {
    ...
    private View getHeaderViewForItem(int headerPosition, @NonNull RecyclerView parent) {
    ...
    @Nullable
    private View getChildInContact(@NonNull RecyclerView parent, int contactPoint, int currentHeaderPos) {
