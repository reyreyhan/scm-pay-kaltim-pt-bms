...
/**
 * Created by Sarif Hidayat on 04/04/2016.
 */
public class JustifyTextView extends androidx.appcompat.widget.AppCompatTextView {
    ...
    public JustifyTextView(@NonNull Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    private void drawScaledText(@NonNull Canvas canvas, int lineStart, @NonNull String line, float lineWidth) {
        float x = 0;
    ...
    private boolean needScale(@Nullable String line) {
