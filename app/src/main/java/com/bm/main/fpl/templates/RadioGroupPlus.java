...
/**
 * Created by sarifhidayat on 12/15/17.
 */
...
public class RadioGroupPlus extends LinearLayout {
    ...
    public RadioGroupPlus(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    /**
     * <p>Register da callback to be invoked when the checked radio button
    ...
    protected boolean checkLayoutParams(ViewGroup.LayoutParams p) {
        return p instanceof RadioGroupPlus.LayoutParams;
    }
    ...
    public CharSequence getAccessibilityClassName() {
        return RadioGroupPlus.class.getName();
    }
     ...
     * for da list of all child view attributes that this class supports.</p>
     */
    ...
    /**
     * <p>Interface definition for da callback to be invoked when the checked
