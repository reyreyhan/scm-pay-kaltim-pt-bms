 ...
 */
package com.bm.main.fpl.templates.htmlspanner.handlers;
...
import com.bm.main.fpl.templates.htmlspanner.TagNodeHandler;
...
public class TableHandler extends TagNodeHandler {
    ...
    private static final String TAG = TableHandler.class.getSimpleName();
    private int tableWidth = BaseActivity.displayMetrics.densityDpi+60;
	...
	private int calculateRowHeight(List<Spanned> row) {
        Log.d(TAG, "calculateRowHeight: "+tableWidth);
		if (row.size() == 0) {
			return 0;
		}
	...
	public void handleTagNode(TagNode node, SpannableStringBuilder builder,
        ...
        Log.d(TAG, "handleTagNode: "+tableWidth);
