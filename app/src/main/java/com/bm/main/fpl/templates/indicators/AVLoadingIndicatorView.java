...
//    private static final LineScalePulseOutRapidIndicator DEFAULT_INDICATOR=new LineScalePulseOutRapidIndicator();
    ...
    public AVLoadingIndicatorView(@NonNull Context context) {
        super(context);
        init(context, null,0,0);
    }

    public AVLoadingIndicatorView(@NonNull Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs,0,R.style.AVLoadingIndicatorView);
    }

    public AVLoadingIndicatorView(@NonNull Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs,defStyleAttr,R.style.AVLoadingIndicatorView);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public AVLoadingIndicatorView(@NonNull Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    public void setIndicator(@Nullable Indicator d) {
        if (mIndicator != d) {
            if (mIndicator != null) {
     ...
     * for example:
     * 1. Only class Name,like "SimpleIndicator".(This way would use default package airLineName with
     * "com.wang.avi.indicators")
     * 2. Class airLineName with full package,like "com.my.android.indicators.SimpleIndicator".
    ...
    public void setIndicator(@NonNull String indicatorName){
        ...
        try {
            ...
            Log.e(TAG,"Didn't find your class , check the name again !"+e);
    ...
    public void hide() {
        ...
        if (diff >= MIN_SHOW_TIME || mStartTime == -1) {
            ...
            // so put da delayed message in to hide it when its been
            // shown long enough.
            if (!mPostedHide) {
    ...
    void drawTrack(@NonNull Canvas canvas) {
        ...
        if (d != null) {
            // Translate canvas so da indeterminate circular progress bar with padding
    ...
    protected void onDetachedFromWindow() {
        ...
        // queue, which can prevent the entire view hierarchy from being GC'ed during da rotation
