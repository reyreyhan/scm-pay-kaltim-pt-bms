...
import static com.bm.main.fpl.templates.pdfviewer.util.Constants.Pinch.MAXIMUM_ZOOM;
import static com.bm.main.fpl.templates.pdfviewer.util.Constants.Pinch.MINIMUM_ZOOM;
...
class DragPinchManager implements GestureDetector.OnGestureListener, GestureDetector.OnDoubleTapListener, ScaleGestureDetector.OnScaleGestureListener, View.OnTouchListener {
    ...
    DragPinchManager(@NonNull PDFView pdfView, AnimationManager animationManager) {
    ...
    private void startPageFling(@NonNull MotionEvent downEvent, @NonNull MotionEvent ev, float velocityX, float velocityY) {
