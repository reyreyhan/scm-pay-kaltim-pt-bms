...
public class ListGridBankVAAdapter extends RecyclerView.Adapter<ListGridBankVAAdapter.ViewHolder> implements Filterable {
    ...
    public OnClickBankVAChoice listener;
    SparseBooleanArray selectedItems;

    public ListGridBankVAAdapter(ArrayList<BankModel.Response_value> data, Context context, OnClickBankVAChoice listener){
        this.data = data;
    ...
    @NonNull
    @Override
    public ListGridBankVAAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
      View v;
...
//        );
    ...
    @Override
    public void onBindViewHolder(@NonNull final ListGridBankVAAdapter.ViewHolder viewHolder, final int i) {
...
//                }
               // notifyDataSetChanged();
                ...
                if (adapterPos != RecyclerView.NO_POSITION) {
                    if (listener != null) {
                        ...
                        listener.onClickBankVAChoice(produk,adapterPos);
                    }
                }
    ...
    public interface OnClickBankVAChoice {
        void onClickBankVAChoice(BankModel.Response_value produk, int adapterPos);
    }
}
