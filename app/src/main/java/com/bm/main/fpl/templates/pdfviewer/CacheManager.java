...
import static com.bm.main.fpl.templates.pdfviewer.util.Constants.Cache.THUMBNAILS_CACHE_SIZE;
...
class CacheManager {
    ...
    public void cacheThumbnail(@NonNull PagePart part) {
     ...
     */
    private void addWithoutDuplicates(@NonNull Collection<PagePart> collection, @NonNull PagePart newPart) {
    ...
    @Nullable
    private static PagePart find(@NonNull PriorityQueue<PagePart> vector, PagePart fakePart) {
    ...
    class PagePartComparator implements Comparator<PagePart> {
        @Override
        public int compare(@NonNull PagePart part1, @NonNull PagePart part2) {
