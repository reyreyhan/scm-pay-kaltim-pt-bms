...
public class DragItem {
    ...
    public void onBindDragView(@NonNull View clickedView, @NonNull View dragView) {
    ...
    public void onMeasureDragView(@NonNull View clickedView, @NonNull View dragView) {
    ...
    void startDrag(@NonNull View startFromView, float touchX, float touchY) {
        show();
    ...
    void endDrag(@NonNull View endToView, AnimatorListenerAdapter listener) {
