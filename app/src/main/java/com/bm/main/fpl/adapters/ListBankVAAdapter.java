...
public class ListBankVAAdapter extends RecyclerView.Adapter<ListBankVAAdapter.ViewHolder> implements Filterable {
    @NonNull
    ...
    public ListBankVAAdapter(ArrayList<BankVAModel.Response_value> data, Context context, OnClickProdukVA listener) {
        this.data = data;
...
//        );
    ...
    public void onBindViewHolder(@NonNull final ViewHolder viewHolder, final int i) {
       ...
       // Log.d(TAG, "onBindViewHolder: ==> "+ produk.getVa_desc()[-1].getType()+" "+produk.getVa_desc()[i].getBank_name());
      //  String[] stringArray = Arrays.copyOf(produk.getVa_desc(), produk.getVa_desc().length, String[].class);

        //System.out.println(Arrays.toString(stringArray));
        //Log.d(TAG, "onBindViewHolder: ==> "+ Arrays.deepToString(produk.getVa_desc()));
       // adapterBankSubVA = new ListBankSubVAAdapter(dataSub, context, context);
//        if(produk.getVa_desc().length>0&&produk.getVa_bank_type().equals("VA")) {
//
//            for (int x = 0; x < produk.getVa_desc().length; x++) {
////if(produk.getVa_bank_name().equals(produk.getVa_desc()[x].getBank_name())) {
//
//                dataSub.add(produk.getVa_desc()[x]);
//              //  Log.d(TAG, "onBindViewHolder: ==> "+ produk.getVa_desc()[x].getType()+" "+produk.getVa_desc()[x].getBank_name());
//    // Log.d(TAG, "onBindViewHolder: "+produk.getVa_desc()[x].getType());
//    // BankVaNewModelResponse_valueVa_descSteper_value[] produk_stepper = produk.getVa_desc()[x].getSteper_value();
//
////                //  viewHolder.textViewSubHeaderVA.setText(produk.getVa_desc()[x].getType());
////     for (int y = x; y < produk.getVa_desc()[x].getSteper_value().length; y++) {
//     for (int y = 0; y < produk.getVa_desc()[x].getSteper_value().length; y++) {
//    //      Log.d(TAG, "onBindViewHolder: "+stepper[y].getDesc_number()+" "+stepper[y].getDesc_name());
//    // stepper.add(produk_stepper[y]);
//
//    stepper.add(produk.getVa_desc()[x].getSteper_value()[y]);
////}
//
//                }
//            }
//        }
//        LinearLayoutManager linearLayoutManagerSubVA = new LinearLayoutManager(context);
////        viewHolder.recyclerViewSubVa.setHasFixedSize(false);
//    //    viewHolder.recyclerViewSubVa.setNestedScrollingEnabled(false);
//
//        viewHolder.recyclerViewSubVa.setLayoutManager(linearLayoutManagerSubVA);
...
//        Glide.with(context).load(produk.getProduct_url()).dontAnimate().skipMemoryCache(true).diskCacheStrategy(DiskCacheStrategy.NONE).into(new GlideDrawableImageViewTarget(viewHolder.imageViewProduk) {
   //     Glide.with(context).load(produk.getProduct_url()).dontAnimate().skipMemoryCache(true).diskCacheStrategy(DiskCacheStrategy.NONE).into(viewHolder.imageViewProduk) {
//
//            Glide.with(context).load(produk.getProduct_url()).override(30, 30).fitCenter().into(viewHolder.imageViewProduk);
...
//
               ...
               viewHolder.materialEditTextNominal24.setOnClickListener(new View.OnClickListener() {
                   ...
                   public void onClick(View v) {
                       // viewHolder.radioGroupBank24.clearCheck();
                       //viewHolder.materialEditTextNominal24.setText("");
                       // clearSelections();
                       //   toggleSelection(-1);
                       //viewHolder.radioButtonNominalBank24 = viewHolder.itemView.findViewById(-1);
                       //viewHolder.radioButtonNominalBank24.setChecked(true);
                    //   viewHolder.radioButtonNominalBank24.setBackground(ContextCompat.getDrawable(context,R.drawable.rbutton_default));
//                       viewHolder.radioButtonNominalBank24.setChecked(false);
//                       viewHolder.nominal24 = 0;
//                       viewHolder.materialEditTextNominal24.setText(String.valueOf(viewHolder.nominal24));
                   }
               });
...
//        viewHolder.linHeaderVA.setVisibility(isExpanded?View.VISIBLE:View.GONE);
...
//
//
//                LinearLayoutManager linearLayoutManagery = new LinearLayoutManager(((DepositActivity)context));
//                viewHolder.recyclerViewSubVa.setHasFixedSize(false);
//                //recyclerViewBankVa.setNestedScrollingEnabled(false);
//                viewHolder.recyclerViewSubVa.setLayoutManager(linearLayoutManagery);
//                adapterBankSubVA=new ListBankSubVAAdapter(dataSub,context,((DepositActivity)context));
//                viewHolder.recyclerViewSubVa.setAdapter(adapterBankSubVA);
