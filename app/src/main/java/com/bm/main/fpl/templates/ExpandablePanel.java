...
/**
 * Created by sarifhidayat on 3/22/18.
 **/
...
public class ExpandablePanel extends LinearLayout {
     ...
     * 'handle' and 'content'
     */
    public ExpandablePanel(@NonNull Context context, AttributeSet attrs) {
        super(context, attrs);
     ...
     * It basically just creates da new animation mInstance and fires
     * animation.
     */
    ...
    /**
     * This is da private animation class that handles the expand/collapse
