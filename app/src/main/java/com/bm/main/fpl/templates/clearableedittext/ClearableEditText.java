...
/** */
public class ClearableEditText extends MaterialEditText implements TextWatcher {

    @DrawableRes
    private static final int DEFAULT_CLEAR_ICON_RES_ID = R.drawable.met_ic_clear;
