...
/**
 * Created by sarifhidayat on 9/11/17.
 */
...
public class AutoResizeTextView extends AppCompatTextView {
    ...
    public AutoResizeTextView(@NonNull final Context context, final AttributeSet attrs, final int defStyle) {
    ...
    private void adjustTextSize() {
        // This is da workaround for truncated text issue on ListView, as shown here: https://github.com/AndroidDeveloperLB/AutoFitTextView/pull/14
        // TODO think of da nicer, elegant solution.
//    post(new Runnable()
//    {
//    @Override
//    public void run()
