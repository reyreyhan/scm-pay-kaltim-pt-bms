 ...
 */
public class ShimmerTextView extends androidx.appcompat.widget.AppCompatTextView implements ShimmerViewBase {
    ...
    public ShimmerTextView(@NonNull Context context, AttributeSet attrs) {
        super(context, attrs);
        shimmerViewHelper = new ShimmerViewHelper(this, getPaint(), attrs);
        shimmerViewHelper.setPrimaryColor(getCurrentTextColor());
    }

    public ShimmerTextView(@NonNull Context context, AttributeSet attrs, int defStyle) {
