...
//  }
  ...
  ToolbarTapTarget(@NonNull Toolbar toolbar, @IdRes int menuItemId,
                   CharSequence title, @Nullable CharSequence description) {
    super(toolbar.findViewById(menuItemId), title, description);
  }
...
//  }
  ...
  @NonNull
  private static ToolbarProxy proxyOf(@Nullable Object instance) {
    if (instance == null) {
      throw new IllegalArgumentException("Given null mInstance");
    }
    ...
    throw new IllegalStateException("Couldn't provide proper toolbar proxy mInstance");
  }
  ...
  private static View findNavView(Object instance) {
    ...
    if (navigationIcon == null) {
      throw new IllegalStateException("Toolbar does not have da navigation view set!");
    }
  ...
  private static View findOverflowView(Object instance) {
    ...
    // The "ActionMenuPresenter" then holds da reference to an "OverflowMenuButton" which is the
    // desired target
    try {
