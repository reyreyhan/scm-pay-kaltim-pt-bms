 ...
 *   2. It used to be a ListView subclass and refactoring the airLineName would cause compatibility errors.
 *
...
public class StickyListHeadersListView extends FrameLayout {
    ...
    public StickyListHeadersListView(@NonNull Context context) {
        this(context, null);
    }

    public StickyListHeadersListView(@NonNull Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.stickyListHeadersListViewStyle);
    }

    @TargetApi(Build.VERSION_CODES.HONEYCOMB)
    public StickyListHeadersListView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyle) {
    ...
    private void ensureHeaderHasCorrectLayoutParams(@NonNull View header) {
    ...
    private void measureHeader(@Nullable View header) {
        if (header != null) {
    ...
    private class WrapperViewListLifeCycleListener implements LifeCycleListener {
        ...
        @Override
        public void onDispatchDrawOccurred(@NonNull Canvas canvas) {
    ...
    public void setAdapter(@Nullable StickyListHeadersAdapter adapter) {
        if (adapter == null) {
    ...
    @Override
    public void setOnTouchListener(@Nullable final OnTouchListener l) {
        if (l != null) {
