...
//    private int fontColor = 0xff0000ff;
    ...
    public RandomTextView(@NonNull Context context)
    {
        super(context);
    ...
    public RandomTextView(@NonNull Context context, AttributeSet attrs)
    {
        super(context, attrs);
        init(attrs, context);
    }

    public RandomTextView(@NonNull Context context, AttributeSet attrs, int defStyleAttr)
    {
    ...
    private void init(AttributeSet attrs, Context context)
    {
        ...
        mContext=context;
        tfThin = ResourcesCompat.getFont(mContext, R.font.roboto_thin);
    ...
    public void show()
    {
        ...
        if (width > 0 && height > 0 && vecKeywords != null && vecKeywords.size() > 0)
        {
            ...
            for (int i = 0; i < size; i++)
            {
                ...
                txt.setText(keyword);
                txt.setBackground(ContextCompat.getDrawable(mContext, R.drawable.ic_bluetooth));
               txt.setCompoundDrawablePadding(15);
               txt.setTypeface(tfThin);
    ...
    private void attach2Screen(@NonNull LinkedList<RippleView> listTxt, int xCenter, int yCenter,
                               int yItem)
    {
    ...
    @NonNull
    private int[] randomXY(@NonNull Random ran, @NonNull LinkedList<Integer> listX,
                           @NonNull LinkedList<Integer> listY, int xItem)
    {
        int[] arr = new int[4];
     ...
     *
     */
    private void sortXYList(@NonNull LinkedList<RippleView> listTxt, int endIdx)
    {
