...
public interface Constants {
    ...
    String DEFAULT_FOLDER_NAME = "FastPay";
    ...
    interface BundleKeys {
        ...
        String ALLOW_MULTIPLE = "allow_multiple";
        String COPY_TAKEN_PHOTOS = "copy_taken_photos";
        String COPY_PICKED_IMAGES = "copy_picked_images";
    }
}
