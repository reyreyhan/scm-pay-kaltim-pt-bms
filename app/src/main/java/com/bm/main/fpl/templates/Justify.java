...
public class Justify {
     ...
     */
    static void setupScaleSpans(@NonNull final @NotNull Justified justified,
                                final @NotNull int[] textViewSpanStarts,
                                final @NotNull int[] textViewSpanEnds,
                                @NonNull final @NotNull ScaleSpan[] textViewSpans) {
...
//      final float w = layout.getLineMax(line);      // Doesn't work well
    ...
    static class ScaleSpan extends MetricAffectingSpan {
        ...
        @Override
        public void updateDrawState(@NonNull final @NotNull TextPaint ds) {
            ds.setTextScaleX(ds.getTextScaleX() * mProportion);
        }

        @Override
        public void updateMeasureState(@NonNull final @NotNull TextPaint ds) {
            ds.setTextScaleX(ds.getTextScaleX() * mProportion);
        }
