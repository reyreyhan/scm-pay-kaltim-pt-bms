package com.bm.main.fpl.templates.banner.layoutmanager;
...
public  class BannerLayoutManager extends RecyclerView.LayoutManager {
   ...
   private float  moveSpeed=1.0f;
    ...
    @Override
    public void onDetachedFromWindow(RecyclerView view, @NonNull RecyclerView.Recycler recycler) {
    ...
    @Override
    public boolean onAddFocusables(@NonNull RecyclerView recyclerView, ArrayList<View> views, int direction, int focusableMode) {
    ...
    @Override
    public int scrollHorizontallyBy(int dx, @NonNull RecyclerView.Recycler recycler, RecyclerView.State state) {
        if (mOrientation == VERTICAL) {
            return 0;
        }
    ...
    @Override
    public int scrollVerticallyBy(int dy, @NonNull RecyclerView.Recycler recycler, RecyclerView.State state) {
        if (mOrientation == HORIZONTAL) {
            return 0;
        }
    ...
    private int scrollBy(int dy, @NonNull RecyclerView.Recycler recycler, RecyclerView.State state) {
    ...
    private void layoutItems(@NonNull RecyclerView.Recycler recycler) {
        detachAndScrapAttachedViews(recycler);
        positionCache.clear();
    ...
    private void layoutScrap(@NonNull View scrap, float targetOffset) {
