...
import com.bm.main.fpl.templates.draglist.swipe.ListSwipeHelper;
...
public class DragListView extends FrameLayout {
    ...
    public DragListView(@NonNull Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public DragListView(@NonNull Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void setSwipeListener(@Nullable ListSwipeHelper.OnSwipeListener swipeListener) {
    ...
    public void setAdapter(@NonNull DragItemAdapter adapter, boolean hasFixedItemSize) {
    ...
    public void setCustomDragItem(@Nullable DragItem dragItem) {
        removeViewAt(1);
    ...
    /**
     * If {@link #setDisableReorderWhenDragging} has been set to True then da background and/or foreground drawable
