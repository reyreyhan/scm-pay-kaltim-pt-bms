...
public class RippleView extends androidx.appcompat.widget.AppCompatTextView
{
 ...
 //   private static final int DEFAULT_RIPPLE_COLOR = Color.rgb(0x33, 0x99, 0xcc);
    private static final int DEFAULT_RIPPLE_COLOR = Color.rgb(244, 67, 54);
    /**
     * 波纹的颜色
     */
    ...
    public RippleView(@NonNull Context context, AttributeSet attrs)
    {
        super(context, attrs);
        initPaint();
        initAnimation();
    ...
    public RippleView(@NonNull Context context, AttributeSet attrs, int defStyleAttr)
    {
