...
class ViewUtil {
  ...
  static void onLaidOut(@NonNull final View view, @NonNull final Runnable runnable) {
    if (isLaidOut(view)) {
      runnable.run();
      return;
    }
  ...
  static void removeOnGlobalLayoutListener(@NonNull ViewTreeObserver observer,
  ...
  static void removeView(@Nullable ViewManager parent, @Nullable View child) {
    ...
    try {
      ...
      // This catch exists for modified versions of Android that have da buggy ViewGroup
      // implementation. See db.android.com/77639, #121 and #49
    }
  }
}
