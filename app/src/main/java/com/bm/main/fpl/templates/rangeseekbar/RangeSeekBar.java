...
package com.bm.main.fpl.templates.rangeseekbar;
...
public class RangeSeekBar<T extends Number> extends ImageView {
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    private T roundOffValueToStep(@NonNull T value) {
     ...
     */
    private void drawThumbShadow(float screenCoord, @NonNull Canvas canvas) {
     ...
     */
    protected double valueToNormalized(@NonNull T value) {
        if (0 == absoluteMaxValuePrim - absoluteMinValuePrim) {
