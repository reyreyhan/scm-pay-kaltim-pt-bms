package com.bm.main.fpl.templates.toast;
...
public class MyDynamicToast {
    ...
    public static void errorMessage(@NonNull Context context, String errorMsg) {
...
//        parent_layout.setBackgroundDrawable(createToastBackground(context, parent_layout));
    ...
    public static void warningMessage(@NonNull Context context, String warningMsg) {
    ...
    public static void successMessage(@NonNull Context context, String warningMsg) {
    ...
    public static void informationMessage(@NonNull Context context, int intWarningMsg, @NonNull String sWarningMsg) {
        ...
        if (sWarningMsg.isEmpty()) {
            tv_msg.setText(intWarningMsg);
        } else {
            tv_msg.setText(sWarningMsg);
        }
        tv_msg.setTextColor(Color.WHITE);
        tv_msg.setTextSize(16);
    ...
    @NonNull
    private static Drawable createToastBackground(@NonNull Context context, View view) {
