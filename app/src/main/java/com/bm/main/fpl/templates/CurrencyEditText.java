...
public class CurrencyEditText extends MaterialEditText {
    ...
    public CurrencyEditText(@NonNull Context context, AttributeSet attrs) {
        super(context, attrs);
//        this.setInputType(InputType.TYPE_CLASS_NUMBER | InputType.TYPE_NUMBER_FLAG_DECIMAL);
    ...
    /***
     * If user does not provide da valid locale it throws IllegalArgumentException.
     *
    ...
    private String format(@NonNull String text) throws NumberFormatException {
        if (mShowSymbol) {
