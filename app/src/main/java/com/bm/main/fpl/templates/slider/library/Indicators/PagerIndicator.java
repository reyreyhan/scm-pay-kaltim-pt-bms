package com.bm.main.fpl.templates.slider.library.Indicators;
...
public class PagerIndicator extends LinearLayout implements ViewPagerEx.OnPageChangeListener{
    ...
    /**
     * bind this Indicator with {@link com.bm.main.fpl.templates.slider.library.Tricks.ViewPagerEx}
     */
    ...
    /**
     *This value is from {@link com.bm.main.fpl.templates.slider.library.SliderAdapter} getRealCount() represent
     *
    ...
    public PagerIndicator(@NonNull Context context, AttributeSet attrs) {
        super(context, attrs);
        ...
        int shape = attributes.getInt(R.styleable.PagerIndicator_shape_slider, Shape.Oval.ordinal());
     ...
     * @param pager
     */
    public void setViewPager(@NonNull ViewPagerEx pager){
