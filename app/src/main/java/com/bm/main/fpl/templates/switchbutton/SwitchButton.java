package com.bm.main.fpl.templates.switchbutton;
...
public class SwitchButton extends CompoundButton {
    ...
    private void setDrawableState(@Nullable Drawable drawable) {
        if (drawable != null) {
    ...
    public void setThumbMargin(@Nullable RectF thumbMargin) {
        if (thumbMargin == null) {
    ...
    public void setThumbSize(@Nullable PointF size) {
        if (size == null) {
