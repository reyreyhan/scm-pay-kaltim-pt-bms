...
public class ClearableTextInputEditText extends TextInputEditText implements TextWatcher {
    ...
    public ClearableTextInputEditText(@NonNull Context context) {
        this(context, null);
    }

    public ClearableTextInputEditText(@NonNull Context context, AttributeSet attrs) {
        this(context, attrs, android.R.attr.editTextStyle);
    }

    public ClearableTextInputEditText(@NonNull Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    @Override public Parcelable onSaveInstanceState() {
        ...
        return mIsClearIconShown ? new ClearIconSavedState(superState,
            true) : superState;
    }
    ...
    @Override public void onRestoreInstanceState(Parcelable state) {
        ...
        ClearIconSavedState savedState =
            (ClearIconSavedState) state;
    ...
    protected static class ClearIconSavedState extends BaseSavedState {
        ...
        public static final Creator<ClearIconSavedState> CREATOR =
            new Creator<ClearIconSavedState>() {
                @NonNull
                @Override public ClearIconSavedState createFromParcel(
