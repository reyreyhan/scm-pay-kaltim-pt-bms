...
public class EmoneyModel extends BaseObject implements Parcelable {

    @SerializedName("response_value")
    private ArrayList<Response_value> response_value;
    private EmoneyModel(Parcel in) {
    }

    public static final Creator<EmoneyModel> CREATOR = new Creator<EmoneyModel>() {
        @NonNull
        @Override
        public EmoneyModel createFromParcel(Parcel in) {
            return new EmoneyModel(in);
        }

        @NonNull
        @Override
        public EmoneyModel[] newArray(int size) {
            return new EmoneyModel[size];
        }
    };

    public ArrayList<EmoneyModel.Response_value> getResponse_value() {
        return response_value;
    }

    public void setResponse_value(ArrayList<EmoneyModel.Response_value> response_value) {
    ...
    public static class Response_value implements Parcelable {
        ...
        public static final Creator<EmoneyModel.Response_value> CREATOR = new Creator<EmoneyModel.Response_value>() {
            @NonNull
            @Override
            public EmoneyModel.Response_value createFromParcel(@NonNull Parcel in) {
                return new EmoneyModel.Response_value(in);
            }

            @NonNull
            @Override
            public EmoneyModel.Response_value[] newArray(int size) {
                return new EmoneyModel.Response_value[size];
            }
        };
