...
/**
 * Displays da sequence of {@link TapTargetView}s.
 * <p>
 * Internally, da FIFO queue is held to dictate which {@link TapTarget} will be shown.
 */
public class TapTargetSequence {
  ...
  public TapTargetSequence(@Nullable AppCompatActivity activity) {
  ...
  /** Whether or not to continue the sequence when da {@link TapTarget} is canceled **/
  @NonNull
  ...
  /** Whether or not to consider taps on the outer circle as da cancellation **/
  @NonNull
  ...
  private final TapTargetView.Listener tapTargetListener = new TapTargetView.Listener() {
    ...
    @Override
    public void onOuterCircleClick(@NonNull TapTargetView view) {
