...
class AdapterWrapper extends BaseAdapter implements StickyListHeadersAdapter {
	 ...
	 */
	@Nullable
    private View configureHeader(@NonNull WrapperView wv, final int position) {
	...
	@Nullable
    @Override
	public WrapperView getView(int position, @Nullable View convertView, ViewGroup parent) {
