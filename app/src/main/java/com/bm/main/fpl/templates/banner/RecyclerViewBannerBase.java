...
public abstract class RecyclerViewBannerBase<L extends RecyclerView.LayoutManager, A extends RecyclerView.Adapter> extends FrameLayout {
    ...
    public RecyclerViewBannerBase(@NonNull Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RecyclerViewBannerBase(@NonNull Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void initView(@NonNull Context context, AttributeSet attrs) {
        ...
        int g = a.getInt(R.styleable.RecyclerViewBannerBase_indicatorGravityBanner, 0);
        int gravity;
        if (g == 0) {
    ...
    protected boolean compareListDifferent(@NonNull List<String> newTabList, @Nullable List<String> oldTabList) {
