...
import com.bm.main.fpl.models.ProdukPulsaRegularModel;
...
public class ListGridProdukPulsaRegularAdapter extends RecyclerView.Adapter<ListGridProdukPulsaRegularAdapter.ViewHolder> implements Filterable {
    private ArrayList<ProdukPulsaRegularModel.Response_value>data = new ArrayList<>();
    private ArrayList<ProdukPulsaRegularModel.Response_value>filterData = new ArrayList<>();
    private Context context;
    private OnClickProduk listener;
    SparseBooleanArray selectedItems;

    public ListGridProdukPulsaRegularAdapter(ArrayList<ProdukPulsaRegularModel.Response_value> data, Context context, OnClickProduk listener){
        this.data = data;
    ...
    @NonNull
    @Override
    public ListGridProdukPulsaRegularAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
...
//        );
    ...
    @Override
    public void onBindViewHolder(@NonNull final ListGridProdukPulsaRegularAdapter.ViewHolder viewHolder, final int i) {
        final ProdukPulsaRegularModel.Response_value produk = filterData.get(i);
...
//                }
        ...
        return new Filter() {
            ...
            protected FilterResults performFiltering(@NonNull CharSequence charSequence) {
                ...
                if (charString.isEmpty()) {
                    ...
                    ArrayList<ProdukPulsaRegularModel.Response_value> filteredList = new ArrayList<>();

                    for (ProdukPulsaRegularModel.Response_value produk : data) {
            ...
            protected void publishResults(CharSequence charSequence, @NonNull FilterResults filterResults) {
                filterData = (ArrayList<ProdukPulsaRegularModel.Response_value>) filterResults.values;
                notifyDataSetChanged();
            }
        };
    }
    ...
    public interface OnClickProduk {
        void onClickProduk(ProdukPulsaRegularModel.Response_value produk);
    }
}
