 ...
 */
package com.bm.main.fpl.templates.pdfviewer;
...
import com.bm.main.fpl.templates.pdfviewer.AnimationManager;
import com.bm.main.fpl.templates.pdfviewer.CacheManager;
import com.bm.main.fpl.templates.pdfviewer.DecodingAsyncTask;
import com.bm.main.fpl.templates.pdfviewer.DragPinchManager;
import com.bm.main.fpl.templates.pdfviewer.PagesLoader;
import com.bm.main.fpl.templates.pdfviewer.RenderingHandler;
import com.bm.main.fpl.templates.pdfviewer.exception.PageRenderingException;
import com.bm.main.fpl.templates.pdfviewer.link.DefaultLinkHandler;
import com.bm.main.fpl.templates.pdfviewer.link.LinkHandler;
import com.bm.main.fpl.templates.pdfviewer.listener.Callbacks;
import com.bm.main.fpl.templates.pdfviewer.listener.OnDrawListener;
import com.bm.main.fpl.templates.pdfviewer.listener.OnErrorListener;
import com.bm.main.fpl.templates.pdfviewer.listener.OnLoadCompleteListener;
import com.bm.main.fpl.templates.pdfviewer.listener.OnLongPressListener;
import com.bm.main.fpl.templates.pdfviewer.listener.OnPageChangeListener;
import com.bm.main.fpl.templates.pdfviewer.listener.OnPageErrorListener;
import com.bm.main.fpl.templates.pdfviewer.listener.OnPageScrollListener;
import com.bm.main.fpl.templates.pdfviewer.listener.OnRenderListener;
import com.bm.main.fpl.templates.pdfviewer.listener.OnTapListener;
import com.bm.main.fpl.templates.pdfviewer.model.PagePart;
import com.bm.main.fpl.templates.pdfviewer.scroll.ScrollHandle;
import com.bm.main.fpl.templates.pdfviewer.source.AssetSource;
import com.bm.main.fpl.templates.pdfviewer.source.ByteArraySource;
import com.bm.main.fpl.templates.pdfviewer.source.DocumentSource;
import com.bm.main.fpl.templates.pdfviewer.source.FileSource;
import com.bm.main.fpl.templates.pdfviewer.source.InputStreamSource;
import com.bm.main.fpl.templates.pdfviewer.source.UriSource;
import com.bm.main.fpl.templates.pdfviewer.util.Constants;
import com.bm.main.fpl.templates.pdfviewer.util.FitPolicy;
import com.bm.main.fpl.templates.pdfviewer.util.MathUtils;
import com.bm.main.fpl.templates.pdfviewer.util.SnapEdge;
...
public class PDFView extends RelativeLayout {
    ...
    public PDFView(@NonNull Context context, AttributeSet set) {
        super(context, set);
    ...
    void onPageError(@NonNull PageRenderingException ex) {
    ...
    private void drawWithListener(@NonNull Canvas canvas, int page, @Nullable OnDrawListener listener) {
        if (listener != null) {
    ...
    private void drawPart(@NonNull Canvas canvas, @NonNull PagePart part) {
    ...
    void loadComplete(@NonNull PdfFile pdfFile) {
        state = State.LOADED;
     ...
     */
    public void onBitmapRendered(@NonNull PagePart part) {
     ...
     */
    public void zoomCenteredTo(float zoom, @NonNull PointF pivot) {
     ...
     */
    public void zoomCenteredRelativeTo(float dzoom, @NonNull PointF pivot) {
