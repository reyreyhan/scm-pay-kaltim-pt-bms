...
class RenderingHandler extends Handler {
    ...
    public void handleMessage(@NonNull Message message) {
        ...
        } catch (@NonNull final PageRenderingException ex) {
            pdfView.post(new Runnable() {
                @Override
                public void run() {
    ...
    @Nullable
    private PagePart proceed(@NonNull RenderingTask renderingTask) throws PageRenderingException {
    ...
    private void calculateBounds(int width, int height, @NonNull RectF pageSliceBounds) {
        renderMatrix.reset();
