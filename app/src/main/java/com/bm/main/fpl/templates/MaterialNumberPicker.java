...
public class MaterialNumberPicker extends NumberPicker {
    ...
    public MaterialNumberPicker(@NonNull Context context, AttributeSet attributeSet) {
    ...
    public MaterialNumberPicker(@NonNull Builder builder) {
    ...
    private float pixelsToSp(@NonNull Context context, float px) {
        return px / context.getResources().getDisplayMetrics().scaledDensity;
    }

    private float spToPixels(@NonNull Context context, float sp) {
