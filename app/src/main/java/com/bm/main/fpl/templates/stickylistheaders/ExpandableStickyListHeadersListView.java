...
public class ExpandableStickyListHeadersListView extends StickyListHeadersListView {
    ...
    IAnimationExecutor mDefaultAnimExecutor = new IAnimationExecutor() {
        @Override
        public void executeAnim(@NonNull View target, int animType) {
    ...
    public ExpandableStickyListHeadersListView(@NonNull Context context) {
        super(context);
    }

    public ExpandableStickyListHeadersListView(@NonNull Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public ExpandableStickyListHeadersListView(@NonNull Context context, AttributeSet attrs, int defStyle) {
     ...
     */
    private void animateView(@NonNull final View target, final int type) {
