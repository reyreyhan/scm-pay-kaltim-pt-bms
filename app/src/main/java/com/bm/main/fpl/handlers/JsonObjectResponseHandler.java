...
public class JsonObjectResponseHandler implements Callback {
    ...
    public JsonObjectResponseHandler(@NonNull AppCompatActivity context, JsonObjectResponseCallback callback, int actionCode) {
...
//        mHandler.post(new Runnable() {
    ...
    @Override
    public void onResponse(Call call, @NonNull Response response) throws IOException,SocketTimeoutException {
        try {
...
//            mHandler.post(new Runnable() {
                ...
                public void run() {
                    FCMConstants.isStillRunningRequest=false;
                    String pesan = res.getString(
                            R.string.failure_message, ResponseCode.RESPONSE_PARSE_ERROR);
