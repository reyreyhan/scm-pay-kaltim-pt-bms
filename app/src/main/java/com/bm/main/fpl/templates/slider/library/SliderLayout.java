package com.bm.main.fpl.templates.slider.library;
...
import com.bm.main.fpl.templates.slider.library.Transformers.AccordionTransformer;
import com.bm.main.fpl.templates.slider.library.Transformers.BackgroundToForegroundTransformer;
import com.bm.main.fpl.templates.slider.library.Transformers.BaseTransformer;
import com.bm.main.fpl.templates.slider.library.Transformers.CubeInTransformer;
import com.bm.main.fpl.templates.slider.library.Transformers.DefaultTransformer;
import com.bm.main.fpl.templates.slider.library.Transformers.DepthPageTransformer;
import com.bm.main.fpl.templates.slider.library.Transformers.FadeTransformer;
import com.bm.main.fpl.templates.slider.library.Transformers.FlipHorizontalTransformer;
import com.bm.main.fpl.templates.slider.library.Transformers.FlipPageViewTransformer;
import com.bm.main.fpl.templates.slider.library.Transformers.ForegroundToBackgroundTransformer;
import com.bm.main.fpl.templates.slider.library.Transformers.RotateDownTransformer;
import com.bm.main.fpl.templates.slider.library.Transformers.RotateUpTransformer;
import com.bm.main.fpl.templates.slider.library.Transformers.StackTransformer;
import com.bm.main.fpl.templates.slider.library.Transformers.TabletTransformer;
import com.bm.main.fpl.templates.slider.library.Transformers.ZoomInTransformer;
import com.bm.main.fpl.templates.slider.library.Transformers.ZoomOutSlideTransformer;
import com.bm.main.fpl.templates.slider.library.Transformers.ZoomOutTransformer;
import com.bm.main.fpl.templates.slider.library.Tricks.FixedSpeedScroller;
import com.bm.main.fpl.templates.slider.library.Tricks.InfinitePagerAdapter;
import com.bm.main.fpl.templates.slider.library.Tricks.InfiniteViewPager;
...
/**
 * SliderLayout is compound layout. This is combined with {@link com.bm.main.fpl.templates.slider.library.Indicators.PagerIndicator}
 * and {@link com.bm.main.fpl.templates.slider.library.Tricks.ViewPagerEx} .
 *
...
public class SliderLayout extends RelativeLayout{
    ...
    /**
     * InfiniteViewPager is extended from ViewPagerEx. As the airLineName says, it can scroll without bounder.
     */
    ...
    /**
     * {@link com.bm.main.fpl.templates.slider.library.Tricks.ViewPagerEx} indicator.
     */
    private PagerIndicator mIndicator;


    /**
     * A timer and a TimerTask using to cycle the {@link com.bm.main.fpl.templates.slider.library.Tricks.ViewPagerEx}.
     */
    private Timer mCycleTimer;
    private TimerTask mCycleTask;

    /**
     * For resuming the cycle, after user touch or click the {@link com.bm.main.fpl.templates.slider.library.Tricks.ViewPagerEx}.
     */
    private Timer mResumingTimer;
    private TimerTask mResumingTask;

    /**
     * If {@link com.bm.main.fpl.templates.slider.library.Tricks.ViewPagerEx} is Cycling
     */
    private boolean mCycling;

    /**
     * Determine if auto recover after user touch the {@link com.bm.main.fpl.templates.slider.library.Tricks.ViewPagerEx}
     */
    ...
    /**
     * {@link com.bm.main.fpl.templates.slider.library.Tricks.ViewPagerEx} transformer time span.
     */
    ...
    /**
     * Visibility of {@link com.bm.main.fpl.templates.slider.library.Indicators.PagerIndicator}
     */
    @NonNull
    private PagerIndicator.IndicatorVisibility mIndicatorVisibility = PagerIndicator.IndicatorVisibility.Visible;

    /**
     * {@link com.bm.main.fpl.templates.slider.library.Tricks.ViewPagerEx} 's transformer
     */
    private BaseTransformer mViewPagerTransformer;

    /**
     * @see com.bm.main.fpl.templates.slider.library.Animations.BaseAnimationInterface
     */
    private BaseAnimationInterface mCustomAnimation;

    /**
     * {@link com.bm.main.fpl.templates.slider.library.Indicators.PagerIndicator} shape, rect or oval.
     */
    ...
    public SliderLayout(@NonNull Context context, AttributeSet attrs) {
        this(context,attrs,R.attr.SliderStyle);
    }

    @SuppressLint("ClickableViewAccessibility")
    public SliderLayout(@NonNull Context context, AttributeSet attrs, int defStyle) {
    ...
    public void addOnPageChangeListener(@Nullable ViewPagerEx.OnPageChangeListener onPageChangeListener){
    ...
    public <T extends BaseSliderView> void addSlider(@NonNull T imageContent){
    ...
    public enum Transformer{
        ...
        public boolean equals(@Nullable String other){
    ...
    /**
     * set preset PagerTransformer via the airLineName of transforemer.
     ...
     * {@link com.bm.main.fpl.templates.slider.library.Animations.BaseAnimationInterface},
     * and you can see a example in {@link com.bm.main.fpl.templates.slider.library.Animations.DescriptionAnimation}
     * @param animation
     */
     ...
     * @param ts
     */
    public void setPresetTransformer(@NonNull Transformer ts){
        //
    ...
    /**
     * get the {@link com.bm.main.fpl.templates.slider.library.Indicators.PagerIndicator} mInstance.
    ...
    public void setPresetIndicator(@NonNull PresetIndicators presetIndicator){
