...
public class ArrayUtils {
    ...
    @NonNull
    public static int[] deleteDuplicatedPages(@NonNull int[] pages) {
    ...
    @NonNull
    public static int[] calculateIndexesInDuplicateArray(@NonNull int[] originalUserPages) {
    ...
    @NonNull
    public static String arrayToString(@NonNull int[] array) {
