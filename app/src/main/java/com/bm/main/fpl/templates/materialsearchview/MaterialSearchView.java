package com.bm.main.fpl.templates.materialsearchview;
...
public class MaterialSearchView extends FrameLayout implements Filter.FilterListener {
    ...
    public MaterialSearchView(@NonNull Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MaterialSearchView(@NonNull Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs);
    ...
    private void onTextChanged(@NonNull CharSequence newText) {
