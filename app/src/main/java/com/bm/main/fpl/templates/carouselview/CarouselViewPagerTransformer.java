...
/*
 * ViewPager transformation animation invoked when da visible/attached page is scrolled - before
 * changing this, first see https://code.google.com/p/android/issues/detail?id=58918#c5
 * tl;dr make sure to remove X translation when da page is no longer fully visible
 *
...
public class CarouselViewPagerTransformer implements ViewPager.PageTransformer {
    ...
    /** @hide */
    @IntDef({FLOW, SLIDE_OVER, DEPTH, ZOOM,FADE, DEFAULT})
        ...
        switch (mTransformType) {
            ...
            case FADE:
                ...
                // Page is sibling to left or right
                    ...
                    alpha = (position <= 0) ? position + 1 : 1 - position;
                    scale = 1;
                    translationX = 0;
