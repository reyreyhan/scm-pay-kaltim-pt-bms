...
import com.bm.main.fpl.templates.pdfviewer.util.FileUtils;
...
public class AssetSource implements DocumentSource {
    ...
    @Override
    public PdfDocument createDocument(@NonNull Context context, @NonNull PdfiumCore core, String password) throws IOException {
