package com.bm.main.fpl.templates.badge;
...
public class QBadgeView extends View implements Badge {
    ...
    @NonNull
    @Override
    public Badge bindTarget(@Nullable final View targetView) {
        if (targetView == null) {
        ...
        if (targetParent != null && targetParent instanceof ViewGroup) {
            ...
            throw new IllegalStateException("targetView must have da parent");
        }
        return this;
    }
    ...
    private void drawDragging(@NonNull Canvas canvas, float startRadius, float badgeRadius) {
    ...
    private void drawBadge(@NonNull Canvas canvas, @NonNull PointF center, float radius) {
    ...
    private void drawBadgeBackground(@NonNull Canvas canvas) {
    ...
    @NonNull
    @Override
    public Badge setOnDragStateChangedListener(@Nullable OnDragStateChangedListener l) {
        mDraggable = l != null;
