...
import com.bca.nfclib.FlazzCardReader;
import com.bca.nfclib.SClassLoader;
import com.bm.main.fpl.utils.PreferenceClass;
import com.cardnfc.lib.bcanfc.Flazz;
import com.cardnfc.lib.bmandirinfc.EMoney;
import com.cardnfc.lib.bninfc.TapCash;
...
import com.cardnfc.lib.brinfc.Brizzi;
...
//                            }
                        ...
                        // Log.d(TAG, "handleNfcTag: masuk flazz");
//          File file = new File(this.mContext.getCacheDir(), "s.dex");
//          if (file.exists()) {
//            file.delete();
//          }
//          AssetManager assets = this.mContext.getAssets();
//          InputStream open = assets != null ? assets.open("flazz.txt") : null;
//          OutputStream bufferedOutputStream = new BufferedOutputStream(new FileOutputStream(file));
////          byte[] bArr = new byte[8192];
//          byte[] bArrx = new byte[' '];
//          bArrx = i1.a(i1.a(open));
//          bufferedOutputStream.write(bArrx, 0, bArrx.length);
...
//          File localObject3 = new File(this.mContext.getCacheDir(), "s.dex");
//          Log.d(TAG, "handleNfcTag: File "+localObject3.toString());
//          if (localObject3.exists()) {
//            localObject3.delete();
//          }
//
//          AssetManager paramTagAsset = this.mContext.getAssets();
//          Log.d(TAG, "handleNfcTag asserM: "+paramTagAsset);
//          if (paramTagAsset == null) {
//           // break label1256;
//            paramTagAsset = null;
//          }
//          InputStream inputStream = paramTagAsset.open("flazz.txt");
//          BufferedOutputStream localObject4 = new BufferedOutputStream(new FileOutputStream( localObject3));
//          byte[] arrayOfByte;
//          arrayOfByte = i.a(i.a(inputStream));
//          localObject4.write(arrayOfByte, 0, arrayOfByte.length);
//          localObject4.close();
//          inputStream.close();
//
//          Context paramTagC = this.mContext;
//          this.mContext.getApplicationContext();
//          File paramTagFileDir = paramTagC.getDir("outdex", 0);
//          Log.d(TAG, "handleNfcTag: tagfile "+paramTagFileDir.getCanonicalPath()+" "+paramTagFileDir.getAbsolutePath());
//
//          StringBuilder localObject4Builder = new StringBuilder();
//          localObject4Builder.append(paramTagFileDir.getCanonicalPath());
////          localObject4Builder.append(paramTagFile.getAbsolutePath());
//          localObject4Builder.append("/s.dex");
//          Log.d(TAG, "handleNfcTag: "+localObject4Builder.toString());
//          File localObject4File = new File(localObject4Builder.toString());
//          Log.d(TAG, "handleNfcTag: 4file "+localObject4File);
//          if (localObject4File.exists()) {
//            localObject4File.delete();
//          }
//
//
//          SClassLoader paramTagSClassLoader = new SClassLoader(new DexClassLoader(paramTagFileDir.getAbsolutePath(), paramTagFileDir.getAbsolutePath(), null, this.mContext.getClassLoader()));
//
//          FlazzCardReader localObject3FlazzCardReader = new FlazzCardReader(tagIsoDep);
//          Log.d(TAG, "handleNfcTag: masuk flazz "+localObject3FlazzCardReader);
//          a paramTagA = new h().a(paramTagSClassLoader, localObject3FlazzCardReader,true);
//          Log.d(TAG, "handleNfcTag: masuk flazz "+paramTagA.a());
                        File file = new File(this.mContext.getCacheDir(), "s.dex");
                        if (file.exists()) {
                            file.delete();
                        }
...
//            throw new Exception("Error read card");
//          } else if (this.mNfcCardReaderListenerSBF != null) {
//            Log.d(TAG, "handleNfcTag: flazz masuk");
//            this.mNfcCardReaderListenerSBF.onFlazzCardFound(a.c(), a.c());
//          }
